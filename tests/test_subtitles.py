...
def test_generate_srt_uses_parametric_scene_duration(tmp_path: Path) -> None:
    scenes = [
        Scene(job_id="job", scene_number=1, duration_seconds=5, visual_prompt="prompt one", narration="n1", subtitle="Uno"),
        Scene(job_id="job", scene_number=2, duration_seconds=5, visual_prompt="prompt two", narration="n2", subtitle="Dos"),
    ]
    output = generate_srt(scenes, tmp_path / "final.srt")
